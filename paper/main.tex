...
planning error. We quantify the effect across three tier matched models, show
that its size tracks how verbosely a model reasons, and separate it from test
time compute scaling by reporting the truncation rate alongside accuracy. We
